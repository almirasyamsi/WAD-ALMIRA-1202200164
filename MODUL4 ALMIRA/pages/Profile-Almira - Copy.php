    ...
    if(isset($_POST["simpan"])) {
        if(ubahuser($_POST)>0){
            ...
            <script>
                ...
                document.location.href='Profile-Almira.php';
            </script>
            ";
        }
  }
            ...
            <li class="nav-item dropdown">
               ...
               <i class="fas fa-user-edit"></i> &nbsp; <?= $nama; ?>
                ...
                <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item text-primary" href="Profile-Almira.php"><i class="far fa-user"></i>&nbsp; Profile</a></li>
                    <li><a class="dropdown-item text-primary" href="Profile-Almira.php"><i class="fas fa-sign-out-alt"></i>&nbsp; Logout</a></li>
                </ul>
            </li>
        </ul>
        </div>
                              ...
                              <form method="POST" action="">
                                <input type="hidden" name="id" value="<?=$row['id']?>">
                                 <div class="mb-3 row">
                                  ...
                                  &emsp;
                                 <a href="Home-Almira.php" class="btn btn-danger" style="width:140px">Cancel</a></Center>
                              </form>       
                      </div>
                  </div> 
              </div>
